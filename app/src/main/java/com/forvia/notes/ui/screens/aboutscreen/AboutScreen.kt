...
package com.forvia.notes.ui.screens.aboutscreen
        ...
        Column(
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(vertical = 8.dp)) {
                    ...
                    AboutDivider()
                    AboutItem(label = "Developer", value = "Forvia")
                    AboutDivider()
            ...
            Card(
                ...
                Column {
                    ActionItem(
                        ...
                        label = "Source Code",
                        onClick = { uriHandler.openUri("https://github.com/TheGreatApollyon/notes") }
                    )
                    AboutDivider()
                    ActionItem(
