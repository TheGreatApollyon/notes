...
package com.forvia.notes.ui.screens.backuprestore
...
import com.forvia.notes.ui.components.BackupDialogType
import com.forvia.notes.ui.components.BackupRestoreDialog
                ...
                BackupRestoreItem(
                    ...
                    onClick = {
                        ...
                        if (uiState.hasDataToExport) {
                            ...
                            exportLauncher.launch("notes_backup_$timeStamp.json")
                        } else {
                            activeDialog = BackupDialogType.NO_DATA_TO_EXPORT
                        }
                    }
